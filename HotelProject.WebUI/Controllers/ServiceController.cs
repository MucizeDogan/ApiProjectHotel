...
namespace HotelProject.WebUI.Controllers
{
    public class ServiceController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("http://localhost:35402/api/Service"); // Bu adrese istekte bullunuyoruz.
        ...
        public async Task<IActionResult> AddService(CreateServiceDto model)
        {
            ...
            var responseMessage = await client.PostAsync("http://localhost:35402/api/Service", stringContent);
        ...
        public async Task<IActionResult> DeleteService(int id)
        {
            ...
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"http://localhost:35402/api/Service/{id}");
            if(responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
        ...
        public async Task<IActionResult> UpdateService(int id)
        {
            ...
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"http://localhost:35402/api/Service/{id}");
            if(!responseMessage.IsSuccessStatusCode)
            {
                return View();
            }
        ...
        public async Task<IActionResult> UpdateService(UpdateServiceDto model)
        {
            ...
            var responseMessage = await client.PutAsync($"http://localhost:35402/api/Service",stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
