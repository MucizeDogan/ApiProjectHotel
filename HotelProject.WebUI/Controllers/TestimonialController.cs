    ...
    public class TestimonialController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (responseMessage.IsSuccessStatusCode)             //Eğer ki burası başarılı bir durum kodu dönerse
            {
                ...
                var data = JsonConvert.DeserializeObject<List<TestimonialViewModel>>(jsonResult);    //Bize gelen data json türünde bu datayı deserilize edeceğiz  
                return View(data);
            }
            return View();
        }
        ...
        public async Task<IActionResult> UpdateTestimonial(int id)
        {
            ...
            var jsonResult = await responseMessage.Content.ReadAsStringAsync(); //Gelen veriyi jsonResult a ata
            var data = JsonConvert.DeserializeObject<TestimonialViewModel>(jsonResult);
            return View(data);
        }
        [HttpPost]
